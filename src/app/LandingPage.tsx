        ...
        <div className="max-w-5xl mx-auto px-4 md:px-5 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <div className="flex items-center gap-3">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/zawaaj.uk/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Zawaaj on Instagram"
              ...
              {/* WhatsApp Channel */}
              <a
                href="https://whatsapp.com/channel/0029VbCJfzM17En1Clwr2N2t"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Zawaaj on WhatsApp"
                className="transition-opacity hover:opacity-100"
                style={{ opacity: 0.55 }}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.558 4.118 1.528 5.845L.057 23.571a.5.5 0 0 0 .614.614l5.726-1.471A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.806 9.806 0 0 1-4.99-1.365l-.358-.212-3.399.873.888-3.327-.232-.375A9.818 9.818 0 0 1 2.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/>
                </svg>
              </a>
            </div>
          </div>
