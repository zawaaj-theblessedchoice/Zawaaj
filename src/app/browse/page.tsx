...
export default async function BrowsePage({
          ...
          <main style={{ marginLeft: 200, flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
            <div style={{ maxWidth: 460, textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                ...
                <a
                  href="mailto:zawaaj.theblessedchoice@gmail.com?subject=Family%20account%20enquiry"
        ...
        <main style={{ marginLeft: 200, flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
          <div style={{ maxWidth: 440, textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a href="mailto:zawaaj.theblessedchoice@gmail.com?subject=Profile%20review%20enquiry" style={{ padding: '9px 20px', borderRadius: 8, border: '0.5px solid var(--border-gold)', background: 'var(--gold-muted)', color: 'var(--gold)', fontSize: 13, textDecoration: 'none' }}>
                Contact us
              </a>
            </div>
          </div>
  ...
  const profiles: ProfileRecord[] = completeRawProfiles.map(p => ({
    ...
    quran_frequency:    p.quran_frequency    ?? null,
    quran_depth:        p.quran_depth        ?? null,
    quran_application:  p.quran_application  ?? null,
  ...
  const typedViewerProfile: ProfileRecord = {
    ...
    quran_frequency:    (viewerProfile as Record<string, unknown>).quran_frequency    as string | null ?? null,
    quran_depth:        (viewerProfile as Record<string, unknown>).quran_depth        as string | null ?? null,
    quran_application:  (viewerProfile as Record<string, unknown>).quran_application  as string | null ?? null,
