...
VALUES
  ...
  (
    ...
    'Hanafi', 'practising', 'yes_regularly',
    'yes', null,
    'never_married', false,
    '5''4"', 'with_family',
    'flexible', 'yes',
  ...
  (
    ...
    'Hanafi', 'steadfast', 'yes_regularly',
    null, true,
    'never_married', false,
    '6''0"', 'with_family',
    'yes', 'yes',
...
VALUES
  (
    ...
    'Hanafi', 'practising', 'yes_regularly',
    'yes', 'never_married', false,
    '5''4"', 'with_family', 'flexible', 'yes',
  ...
  (
    ...
    'Hanafi', 'striving', 'most_of_time',
    'yes', 'never_married', false,
    '5''5"', 'with_family', 'flexible', 'yes',
  ...
  (
    ...
    'Hanafi', 'practising', 'yes_regularly',
    'no', 'never_married', false,
    '5''6"', 'with_family', 'yes', 'yes',
  ...
  (
    ...
    'Hanafi', 'steadfast', 'yes_regularly',
    'yes', 'divorced', false,
    '5''3"', 'independently', 'flexible', 'yes',
  ...
  (
    ...
    'Junior doctor', 'Postgraduate degree',
    'General Sunni', 'practising', 'yes_regularly',
    'yes', 'never_married', false,
    '5''5"', 'with_family', 'yes', 'yes',
  ...
  (
    ...
    'General Sunni', 'practising', 'most_of_time',
    'yes', 'never_married', false,
    '5''4"', 'with_family', 'flexible', 'yes',
...
VALUES
  (
    ...
    'General Sunni', 'practising', 'yes_regularly',
    true, 'never_married', false,
    '5''11"', 'with_family', 'flexible', 'yes',
  ...
  (
    ...
    'British Pakistani', ARRAY['English','Urdu','Punjabi'],
    'Solicitor', 'Postgraduate degree',
    'Hanafi', 'practising', 'most_of_time',
    true, 'never_married', false,
    '5''11"', 'with_family', 'flexible', 'yes',
  ...
  (
    ...
    'General Sunni', 'steadfast', 'yes_regularly',
    true, 'never_married', false,
    '6''1"', 'with_family', 'yes', 'yes',
