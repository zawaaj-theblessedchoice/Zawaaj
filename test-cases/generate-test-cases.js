...
const gdprRows = [
  ...
  row('GDPR', 'Settings — Privacy tab', 'Privacy tab visible in account settings',
    ...
    'Privacy tab content loads showing: data protection summary, "Download a copy of my data" section, "Delete my account" section, and links to Privacy Policy and Terms'),
  ...
  row('GDPR', 'Settings — Privacy tab', 'Member can request a copy of their data from Settings',
    ...
    'Button shows "Sending…" briefly; then a green success message appears: "Done — a copy of your data has been sent to your registered email address." An email arrives with the data attached.'),
  ...
  row('GDPR', 'Settings — Privacy tab', 'Second export request within 30 days is blocked',
    ...
    'An error message appears explaining that only one data export is allowed every 30 days'),
  ...
  row('GDPR', 'Settings — Privacy tab', 'Delete account button appears in Settings',
    ...
    '"Delete my account" button visible with a brief explanation of the 7-day waiting period'),
  ...
  row('GDPR', 'Delete My Account', 'Delete account requires ticking confirmation box and typing a phrase',
    ...
    'The "Request account deletion" button is greyed out and cannot be clicked — both the tick box and the exact phrase must be completed first'),
  ...
  row('GDPR', 'Delete My Account', 'Delete account submitted successfully',
    ...
    'Red confirmation message shown: "Deletion request submitted — your profile has been removed from the directory. Account will be permanently deleted in 7 days." A cancellation email is sent to the registered address.'),
  ...
  row('GDPR', 'Delete My Account', 'Cancel button during deletion flow works',
    ...
    'Form closes; returns to the normal privacy tab view; nothing is deleted'),
  ...
  row('GDPR', 'Delete My Account', 'Member can cancel their deletion request via email link',
    ...
    'A webpage opens confirming the deletion has been cancelled; the account is restored to a paused state (profile is not in the directory but the account is still active)'),
  ...
  row('GDPR', 'Correct My Data', 'Member can submit a correction request via the data rights portal',
    ...
    'Success message shown — request has been submitted; visible in the Request History tab with status "Pending"; admin will review and make the correction'),
  ...
  row('GDPR', 'Correct My Data', 'Cannot have more than 3 open correction requests at once',
    ...
    'Error message shown — cannot submit more than 3 correction requests at a time; advised to wait for existing requests to be resolved first'),
  ...
  row('GDPR', 'Data Rights History', 'Request history accessible at /privacy/rights',
    ...
    'All past data requests listed with type (e.g. Data export, Correction, Deletion), date submitted, and current status'),

  row('GDPR', 'Data Rights History', 'Empty history shows a friendly message',
    'Signed in; no data requests have ever been submitted',
    '1. Go to zawaaj.uk/privacy/rights\n2. Click "Request history" tab',
    'A message is shown such as "No requests yet" — no blank or broken table'),
]
